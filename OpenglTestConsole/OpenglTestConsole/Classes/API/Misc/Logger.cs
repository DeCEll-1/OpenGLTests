...
namespace OpenglTestConsole.Classes.api.misc
{
    ...
    public class LogColors
    {
        ...
        public static string BRIGHT_BLACK_BACKGROUND = Console.IsOutputRedirected ? "" : "\x1b[100m";
        public static string BRIGHT_RED_BACKGROUND = Console.IsOutputRedirected ? "" : "\x1b[101m";
        public static string BRIGHT_GREEN_BACKGROUND = Console.IsOutputRedirected ? "" : "\x1b[102m";
        public static string BRIGHT_YELLOW_BACKGROUND = Console.IsOutputRedirected ? "" : "\x1b[103m";
        public static string BRIGHT_BLUE_BACKGROUND = Console.IsOutputRedirected ? "" : "\x1b[104m";
        public static string BRIGHT_MAGENTA_BACKGROUND = Console.IsOutputRedirected ? "" : "\x1b[105m";
        public static string BRIGHT_CYAN_BACKGROUND = Console.IsOutputRedirected ? "" : "\x1b[106m";
        public static string BRIGHT_WHITE_BACKGROUND = Console.IsOutputRedirected ? "" : "\x1b[107m";
        #endregion
        ...
        public static string BrightBlack(object source) => BRIGHT_BLACK + source.ToString() + NORMAL;
        public static string BrightRed(object source) => BRIGHT_RED + source.ToString() + NORMAL;
        public static string BrightGreen(object source) => BRIGHT_GREEN + source.ToString() + NORMAL;
        public static string BrightYellow(object source) => BRIGHT_YELLOW + source.ToString() + NORMAL;
        public static string BrightBlue(object source) => BRIGHT_BLUE + source.ToString() + NORMAL;
        public static string BrightMagenta(object source) => BRIGHT_MAGENTA + source.ToString() + NORMAL;
        public static string BrightCyan(object source) => BRIGHT_CYAN + source.ToString() + NORMAL;
        public static string BrightWhite(object source) => BRIGHT_WHITE + source.ToString() + NORMAL;
        public static string BlackBackground(object source) => BLACK_BACKGROUND + source.ToString() + NORMAL;
        public static string RedBackground(object source) => RED_BACKGROUND + source.ToString() + NORMAL;
        public static string GreenBackground(object source) => GREEN_BACKGROUND + source.ToString() + NORMAL;
        public static string YellowBackground(object source) => YELLOW_BACKGROUND + source.ToString() + NORMAL;
        public static string BlueBackground(object source) => BLUE_BACKGROUND + source.ToString() + NORMAL;
        public static string MagentaBackground(object source) => MAGENTA_BACKGROUND + source.ToString() + NORMAL;
        public static string CyanBackground(object source) => CYAN_BACKGROUND + source.ToString() + NORMAL;
        public static string WhiteBackground(object source) => WHITE_BACKGROUND + source.ToString() + NORMAL;
        public static string BrightBlackBackground(object source) => BRIGHT_BLACK_BACKGROUND + source.ToString() + NORMAL;
        public static string BrightRedBackground(object source) => BRIGHT_RED_BACKGROUND + source.ToString() + NORMAL;
        public static string BrightGreenBackground(object source) => BRIGHT_GREEN_BACKGROUND + source.ToString() + NORMAL;
        public static string BrightYellowBackground(object source) => BRIGHT_YELLOW_BACKGROUND + source.ToString() + NORMAL;
        public static string BrightBlueBackground(object source) => BRIGHT_BLUE_BACKGROUND + source.ToString() + NORMAL;
        public static string BrightMagentaBackground(object source) => BRIGHT_MAGENTA_BACKGROUND + source.ToString() + NORMAL;
        public static string BrightCyanBackground(object source) => BRIGHT_CYAN_BACKGROUND + source.ToString() + NORMAL;
        public static string BrightWhiteBackground(object source) => BRIGHT_WHITE_BACKGROUND + source.ToString() + NORMAL;
        #endregion
