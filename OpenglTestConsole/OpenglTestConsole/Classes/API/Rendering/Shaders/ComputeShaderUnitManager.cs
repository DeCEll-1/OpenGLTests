...
using static OpenglTestConsole.Classes.API.Rendering.Shaders.ComputeShaderUnitManager;
using static OpenglTestConsole.Classes.Paths.ResourcePaths;
...
namespace OpenglTestConsole.Classes.API.Rendering.Shaders
{
    public class ComputeShaderUnitManager
    {
        public struct ImageBinding
        {
            ...
            public ImageBinding(int unit, int texture, TextureAccess access, SizedInternalFormat format)
            {
                Unit = unit;
                Texture = texture;
                Access = access;
        ...
        public void SetImageTexture(int texture, int unit, TextureAccess access = TextureAccess.ReadWrite, SizedInternalFormat format = SizedInternalFormat.Rgba32f)
        {
