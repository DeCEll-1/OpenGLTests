...
$linkData = Get-Content "Resources/links.json" -Raw | ConvertFrom-Json
...
$cylinderObjects | ConvertTo-Json -Depth 3 | Out-File "Resources/cylinders.json" -Encoding utf8
